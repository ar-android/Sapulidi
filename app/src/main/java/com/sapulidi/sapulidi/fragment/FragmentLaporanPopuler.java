 ...
 */
public class FragmentLaporanPopuler extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_laporanpopular, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ListView list = (ListView) getActivity().findViewById(R.id.lvPopuler);
